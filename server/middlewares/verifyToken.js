...
// ? Here we just verify the token to acces basic setting like add cart when shopping
...
// ? This is used for update or delete account/reviews/destination because system needs to know if the right person logged in actually can mutate the data
